                        ...
                        {!forcedRole && (
                            <div className="input-group">
                                ...
                                <div className="role-picker">
                                    <button className={`role-btn ${user === 'student' ? 'active' : ''}`} onClick={() => setUser('student')}>Student</button>
                                    <button className={`role-btn ${user === 'instructor' ? 'active' : ''}`} onClick={() => setUser('instructor')}>Instructor</button>
